...
var cars_Ref = firebase.database().ref('/LAMPARAS_E1CVO');


var dataConductores = firebase.database().ref('/LAMPARAS_E1CVO');
...
var pedidos_Ref = firebase.database().ref('/RPUMEDIDOR_E1CVO');
